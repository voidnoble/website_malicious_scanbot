...
const webhook = new IncomingWebhook(webHookUrl);
    ...
    (async() => {
        ...
        const functionWhitelists = ["goto_tab","showFlash","getFlashHtml","hideTopBanner","jq__slideUpAndRemove","isMsIe","isMsIe11","open_win","close_win","scroll_realtimenews","openPopup","pre_img","next_img","set_slide","img_resize","comment_length_check","submit_comment_form","print_article","goto_page","twitter_login","facebook_login","me2day_login","sns_login_success","Prism_PlayerSetting","responseAdparamData","setPlayData","Prism_onStateEventHandler","Prism_finishEventHandler"];
